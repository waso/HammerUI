...
import com.wsojka.hammerui.controllers.authentication.BasicAuthenticationController;
...
public class BasicAuthentication extends Authentication implements Serializable {

    @Serial
    private static final long serialVersionUID = -8551264224885786318L;
    ...
    public void setAuthenticationDetailsPane(Pane authenticationDetailsPane, AppTheme theme) {
        ...
        Pane newLoadedPane;
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/fxml/authentication/BasicAuthentication.fxml"));
            newLoadedPane = loader.load();
            BasicAuthenticationController controller = loader.getController();
